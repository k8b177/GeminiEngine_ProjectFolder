...
public:
	...
	Texture(const char * const _assetName, int filtermode = GL_LINEAR);

	// Load directly from array 0f GLbyte
	Texture(GLbyte* pixArray, int width, int height, int filtermode = GL_LINEAR, GLenum eFrmt = GL_RGBA);
